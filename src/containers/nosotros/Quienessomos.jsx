    ...
    <section className="bg-white font-NUNITO">
      <div className="container px-6 py-10 mx-auto">
        ...
        <div className="flex items-start max-w-6xl mx-auto mt-16">
          <div>
            <p className="flex items-center text-justify   text-gray-900 sm:mb-12 lg:mx-8">
              ...
              unen para brindar una atención integral. Nuestro objetivo es
              convertirnos en la empresa líder en salud infantil en la
              provincia, con proyección nacional y regional. Nuestra misión es
              brindar un servicio médico de calidad excepcional los 365 días del
              año, brindando seguridad y confiabilidad a las familias.
            </p>
